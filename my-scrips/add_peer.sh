...
peer channel fetch 0 ./channel-artifacts/channel2_org7.block -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com -c channel2 --tls --cafile ${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
peer channel join -b ./channel-artifacts/channel2_org7.block

peer channel fetch 0 ./channel-artifacts/channel3_org7.block -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com -c channel3 --tls --cafile ${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
peer channel join -b ./channel-artifacts/channel3_org7.block

peer channel fetch 0 ./channel-artifacts/channel4_org7.block -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com -c channel4 --tls --cafile ${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
peer channel join -b ./channel-artifacts/channel4_org7.block

peer channel fetch 0 ./channel-artifacts/channel5_org7.block -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com -c channel5 --tls --cafile ${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
peer channel join -b ./channel-artifacts/channel5_org7.block
